...
def upgrade():
    ...
    sa.Column('group_id', sa.String(), nullable=True),
    sa.Column('split_type', sa.Enum('BY_SHARE', 'BY_PERCENTAGE', 'BY_ADJUSTMENT', 'EQUAL', 'UNEQUAL', name='splittype'), nullable=True),
    ...
    op.create_index(op.f('ix_deposit_deposit_id'), 'deposit', ['deposit_id'], unique=False)
    ...
    op.create_index(op.f('ix_withdrawal_withdrawal_id'), 'withdrawal', ['withdrawal_id'], unique=False)
